...
pub enum ExpressionKind {
    ...
    FunctionCall { func_name: Symbol, actual_params: Vec<Box<Expression>> },
}
    ...
    fn parse_identifier(&mut self) -> Result<Symbol, ParserError> {
        match self.token_provider.next() {
            Some(Ok(Token { location, token_type })) => {
                match token_type {
                    TokenType::Identifier(name) => Ok(Symbol { name: name.to_string(), location, original_name: None }),
                ...
                match token_type {
                    ...
                    TokenType::Identifier(identifier) => {
                        ...
                        match next_tok {
                            None => Ok(Expression {
                                location: tok_location,
                                kind: ExpressionKind::Variable(ident_symbol),
                            }),
                            Some(Err(e)) => Err(TokenizationError(e.clone())),
                            Some(Ok(tok)) => {
                                match tok.token_type {
...
mod test {
                                ...
                                BlockItem::Statement(Statement {
                                    ...
                                    kind: Return(Expression {
                                        ...
                                        kind: Binary(
                                            ...
                                            Box::new(Expression {
                                                location: (2,12).into(),
                                                kind: Variable(Symbol{ name: "a".to_string(), location: (2,12).into(), original_name: None }),
                                            }),
                                            Box::new(Expression {
                                                location: (2,16).into(),
                                                kind: Variable(Symbol{ name: "b".to_string(), location: (2,16).into(), original_name: None }),
                                            }),
                                        ),
                                    }),
                                }),
            ...
            kind: StatementKind::Expression(Expression {
                ...
                kind: Increment {
                    ...
                    e: Box::new(Expression {
                        location: (1,1).into(),
                        kind: Variable(Symbol { name: "a".to_string(), location: (1,1).into(), original_name: None }),
                    }),
                },
            }),
        });
            ...
            kind: StatementKind::Expression(Expression {
                ...
                kind: Assignment {
                    lvalue: Box::new(Expression {
                        location: (1, 1).into(),
                        kind: Variable(Symbol { name: "a".to_string(), original_name: None, location: (1,1).into() }),
                    }),
        ...
        let expected = Ok(Statement {
            ...
            kind: If {
                condition: Box::new(Expression {
                    location: (1,5).into(),
                    kind: Variable(Symbol { name: "a".to_string(), original_name: None, location: (1,5).into() }),
                }),
                then_statement: Box::new(Statement {
                    ...
                    kind: StatementKind::Expression(Expression {
                        location: (1,8).into(),
                        kind: Variable(Symbol { name: "b".to_string(), original_name: None, location: (1,8).into() }),
                    }),
                }),
                else_statement: None,
            },
    ...
    fn test_parse_statement_simple_if_block_with_else() {
        ...
        let expected = Ok(Statement {
            ...
            kind: If {
                condition: Box::new(Expression {
                    location: (1, 5).into(),
                    kind: Variable(Symbol { name: "a".to_string(), location: (1,5).into(), original_name: None }),
                }),
                then_statement: Box::new(Statement {
                    location: (1, 8).into(),
                    labels: vec![],
                    kind: Expression(Expression {
                        location: (1, 8).into(),
                        kind: Variable(Symbol { name: "b".to_string(), location: (1, 8).into(), original_name: None }),
                    }),
                }),
                else_statement: Some(Box::new(Statement {
                    ...
                    kind: Expression(Expression {
                        location: (1, 16).into(),
                        kind: Variable(Symbol { name: "c".to_string(), location: (1, 16).into(), original_name: None }),
                    }),
                })),
            },
        });
                ...
                then_statement: Box::new(Statement {
                    ...
                    kind: SubBlock(Block {
                        ...
                        items: vec![BlockItem::Statement(Statement {
                            ...
                            kind: Return(Expression {
                                location: (1, 17).into(),
                                kind: Variable(Symbol { name: "b".to_string(), location: (1, 17).into(), original_name: None }),
                            }),
                        })],
                    }),
                }),
                    ...
                    kind: SubBlock(Block {
                        ...
                        items: vec![
                            BlockItem::Statement(Statement {
                                ...
                                kind: Expression(Expression {
                                    ...
                                    kind: Assignment {
                                        lvalue: Box::new(Expression {
                                            location: (1, 29).into(),
                                            kind: Variable(Symbol { name: "b".to_string(), location: (1, 29).into(), original_name: None }),
                                        }),
                                        rvalue: Box::new(Expression {
                                            location: (1, 34).into(),
                                            kind: IntConstant("10".to_string(), Decimal),
                            ...
                            BlockItem::Statement(Statement {
                                ...
                                kind: Return(Expression {
                                    location: (1, 45).into(),
                                    kind: Variable(Symbol { name: "b".to_string(), location: (1, 45).into(), original_name: None }),
                                }),
                            }),
                        ],
                    }),
                    ...
                    kind: If {
                        condition: Box::new(Expression {
                            ...
                            kind: Binary(
                                ...
                                Box::new(Expression {
                                    location: (3, 10).into(),
                                    kind: Variable(Symbol { name: "a".to_string(), location: (3, 10).into(), original_name: None }),
                                }),
                                Box::new(Expression {
                                    location: (3, 14).into(),
            ...
            kind: If {
                ...
                then_statement: Box::new(Statement {
                    ...
                    kind: If {
                        condition: Box::new(Expression {
                            location: (2, 9).into(),
                            kind: Variable(Symbol { name: "b".to_string(), location: (2, 9).into(), original_name: None }),
                        }),
                        then_statement: Box::new(Statement {
                            labels: vec![],
                            location: (3, 9).into(),
        ...
        let expected = Ok(Statement {
            ...
            kind: StatementKind::Expression(Expression {
                ...
                kind: Assignment {
                    lvalue: Box::new(Expression {
                        location: (1, 4).into(),
                        kind: Variable(Symbol { name: "a".to_string(), location: (1, 4).into(), original_name: None }),
                    }),
                    rvalue: Box::new(Expression {
                        location: (1, 8).into(),
                        kind: IntConstant("10".to_string(), Decimal),
        ...
        let expected = Ok(Statement {
            ...
            kind: StatementKind::Expression(Expression {
                ...
                kind: Assignment {
                    lvalue: Box::new(Expression {
                        location: (1,10).into(),
                        kind: Variable(Symbol { name: "a".to_string(), location: (1, 10).into(), original_name: None }),
                    }),
                    rvalue: Box::new(Expression {
                        location: (1, 14).into(),
                        kind: IntConstant("10".to_string(), Decimal),
    ...
    fn test_parse_statement_labeled_if() {
        ...
        let expected = Ok(Statement {
            ...
            kind: If {
                condition: Box::new(Expression {
                    location: (2, 9).into(),
                    kind: Variable(Symbol { name: "a".to_string(), location: (2, 9).into(), original_name: None }),
                }),
                then_statement: Box::new(Statement {
                    location: (2, 12).into(),
                    labels: vec![],
                    kind: StatementKind::Expression(Expression {
                        location: (2, 12).into(),
                        kind: Variable(Symbol { name: "b".to_string(), location: (2, 12).into(), original_name: None }),
                    }),
                }),
                else_statement: Some(Box::new(Statement {
                    location: (2, 20).into(),
                    ...
                    kind: StatementKind::Expression(Expression {
                        location: (2, 20).into(),
                        kind: Variable(Symbol { name: "c".to_string(), location: (2, 20).into(), original_name: None }),
                    }),
                })),
            },
        });
            ...
            kind: For {
                ...
                condition: Some(Box::new(Expression {
                    ...
                    kind: Binary(
                        ...
                        Box::new(Expression {
                            location: (1, 17).into(),
                            kind: Variable(Symbol { name: "i".to_string(), location: (1, 17).into(), original_name: None }),
                        }),
                        Box::new(Expression {
                            location: (1, 21).into(),
                            kind: IntConstant("10".to_string(), Decimal),
                ...
                post: Some(Box::new(Expression {
                    ...
                    kind: Increment {
                        ...
                        e: Box::new(Expression {
                            location: (1, 25).into(),
                            kind: Variable(Symbol { name: "i".to_string(), location: (1, 25).into(), original_name: None }),
                        }),
                    },
                })),
                loop_body: Box::new(Statement {
                    ...
                    kind: StatementKind::Expression(Expression {
                        ...
                        kind: Assignment {
                            lvalue: Box::new(Expression {
                                location: (2, 5).into(),
                                kind: Variable(Symbol { name: "x".to_string(), location: (2, 5).into(), original_name: None }),
                            }),
                            rvalue: Box::new(Expression {
                                location: (2, 9).into(),
                                kind: Binary(
                                    ...
                                    Box::new(Expression {
                                        location: (2, 9).into(),
                                        kind: Variable(Symbol { name: "x".to_string(), location: (2, 9).into(), original_name: None }),
                                    }),
                                    Box::new(Expression {
                                        location: (2, 13).into(),
                                        kind: Variable(Symbol { name: "i".to_string(), location: (2, 13).into(), original_name: None }),
                                    }),
                                ),
                            }),
                            op: None,
            ...
            kind: For {
                init: ForInit::InitExpr(Box::new(
                    Expression {
                        ...
                        kind: Assignment {
                            lvalue: Box::new(Expression {
                                location: (1,6).into(),
                                kind: Variable(Symbol { name: "i".to_string(), location: (1,6).into(), original_name: None }),
                            }),
                            rvalue: Box::new(Expression {
                                location: (1,10).into(),
                                kind: IntConstant("0".to_string(), Decimal),
                ...
                condition: Some(Box::new(Expression {
                    ...
                    kind: Binary(
                        ...
                        Box::new(Expression {
                            location: (1,13).into(),
                            kind: Variable(Symbol { name: "i".to_string(), location: (1,13).into(), original_name: None })
                        }),
                        Box::new(Expression {
                            location: (1,17).into(),
                            kind: IntConstant("10".to_string(), Decimal)
                ...
                post: Some(Box::new(Expression {
                    ...
                    kind: Increment {
                        ...
                        e: Box::new(Expression {
                            location: (1,21).into(),
                            kind: Variable(Symbol { name: "i".to_string(), location: (1,21).into(), original_name: None })
                        }),
                    },
                })),
                loop_body: Box::new(Statement {
                    ...
                    kind: StatementKind::Expression(Expression {
                        ...
                        kind: Assignment {
                            ...
                            rvalue: Box::new(Expression {
                                location: (2,10).into(),
                                kind: Variable(Symbol { name: "i".to_string(), location: (2,10).into(), original_name: None }),
                            }),
                            op: Some(CompoundAssignmentType::Add),
                        },
                    }),
            ...
            kind: For {
                init: ForInit::InitExpr(Box::new(Expression {
                    ...
                    kind: Assignment {
                        lvalue: Box::new(Expression {
                            location: (1, 9).into(),
                            kind: Variable(Symbol { name: "i".to_string(), location: (1, 9).into(), original_name: None }),
                        }),
                        rvalue: Box::new(Expression {
                            location: (1, 13).into(),
                ...
                condition: Some(Box::new(Expression {
                    ...
                    kind: Binary(
                        ...
                        Box::new(Expression {
                            location: (1, 16).into(),
                            kind: Variable(Symbol { name: "i".to_string(), location: (1, 16).into(), original_name: None }),
                        }),
                        Box::new(Expression {
                            location: (1, 20).into(),
                ...
                post: Some(Box::new(Expression {
                    ...
                    kind: Increment {
                        ...
                        e: Box::new(Expression {
                            location: (1, 24).into(),
                            kind: Variable(Symbol { name: "i".to_string(), location: (1, 24).into(), original_name: None }),
                        }),
                    },
                })),
                loop_body: Box::new(Statement {
                    ...
                    kind: StatementKind::Expression(Expression {
                        ...
                        kind: Assignment {
                            lvalue: Box::new(Expression {
                                location: (1, 29).into(),
                                kind: Variable(Symbol { name: "x".to_string(), location: (1, 29).into(), original_name: None }),
                            }),
                            rvalue: Box::new(Expression {
                                location: (1, 34).into(),
                                kind: Variable(Symbol { name: "i".to_string(), location: (1, 34).into(), original_name: None }),
                            }),
                            op: Some(CompoundAssignmentType::Add),
                        },
                    }),
            ...
            kind: While {
                pre_condition: Box::new(Expression {
                    ...
                    kind: Binary(
                        ...
                        Box::new(Expression {
                            location: (1, 8).into(),
                            kind: Variable(Symbol { name: "x".to_string(), location: (1, 8).into(), original_name: None }),
                        }),
                        Box::new(Expression {
                            location: (1, 12).into(),
                            kind: IntConstant("10".into(), Decimal),
                ...
                loop_body: Box::new(Statement {
                    ...
                    kind: StatementKind::Expression(Expression {
                        ...
                        kind: Increment {
                            ...
                            e: Box::new(Expression {
                                location: (1, 16).into(),
                                kind: Variable(Symbol { name: "x".to_string(), location: (1, 16).into(), original_name: None }),
                            }),
                        },
                    }),
                }),
            ...
            kind: DoWhile {
                            ...
                            BlockItem::Statement(Statement {
                                ...
                                kind: Expression(Expression {
                                    ...
                                    kind: Decrement {
                                        ...
                                        e: Box::new(Expression {
                                            location: (2,12).into(),
                                            kind: Variable(Symbol { name: "y".to_string(), location: (2, 12).into(), original_name: None }),
                                        }),
                                    },
                                }),
                            }),
                ...
                post_condition: Box::new(Expression {
                    ...
                    kind: Binary(
                        ...
                        Box::new(Expression {
                            location: (3,10).into(),
                            kind: Variable(Symbol { name: "x".to_string(), location: (3,10).into(), original_name: None }),
                        }),
                        Box::new(Expression {
                            location: (3,14).into(),
                            kind: IntConstant("10".into(), Decimal),
    ...
    fn test_parse_expression_function_call() {
        ...
        let expected = Ok(Expression {
            location: (1,1).into(),
            kind: FunctionCall {
                func_name: Symbol { name: "foo".to_string(), location: (1,1).into(), original_name: None },
                actual_params: vec![
            ...
            kind: Assignment {
                ...
                rvalue: Box::new(Expression {
                    ...
                    kind: Assignment {
                        lvalue: Box::new(Expression {
                            location: (1, 3).into(),
                            kind: Variable(Symbol { name: "b".to_string(), location: (1, 3).into(), original_name: None }),
                        }),
                        rvalue: Box::new(Expression {
                            location: (1, 5).into(),
                            kind: IntConstant("10".to_string(), Decimal),
    ...
    fn test_parse_expression_compound_assignment_add() {
        ...
        let expected = Ok(Expression {
            ...
            kind: Assignment {
                ...
                rvalue: Box::new(Expression {
                    location: (1,6).into(),
                    kind: Variable(Symbol { name: "b".to_string(), location: (1, 6).into(), original_name: None }),
                }),
                op: Some(CompoundAssignmentType::Add),
            },
        });
    ...
    fn test_parse_expression_compound_assignment_left_shift() {
        ...
        let expected = Ok(Expression {
            ...
            kind: Assignment {
                ...
                rvalue: Box::new(Expression {
                    location: (1,7).into(),
                    kind: Variable(Symbol { name: "b".to_string(), location: (1, 7).into(), original_name: None }),
                }),
    ...
    fn test_parse_expression_pre_decrement() {
        ...
        let expected = Ok(Expression {
            ...
            kind: Decrement {
                ...
                e: Box::new(Expression {
                    location: (1,3).into(),
                    kind: Variable(Symbol { name: "a".to_string(), location: (1,3).into(), original_name: None })
                })
            }
        });
        run_parse_expression_test_case(ExprTestCase { src, expected });
        ...
        run_parse_expression_test_case(ExprTestCase {
            ...
            expected: Ok(Expression {
                ...
                kind: Conditional {
                    condition: Box::new(Expression {
                        location: (1,1).into(),
                        kind: Variable(Symbol { name: "is_expected".to_string(), location: (1,1).into(), original_name: None }),
                    }),
                ...
                kind: Assignment {
                    ...
                    rvalue: Box::new(Expression {
                        ...
                        kind: Conditional {
                            condition: Box::new(Expression {
                                location: (1, 5).into(),
                                kind: Variable(Symbol { name: "b".to_string(), location: (1, 5).into(), original_name: None }),
                            }),
                            then_expr: Box::new(Expression {
                                location: (1, 9).into(),
                                kind: IntConstant("1".to_string(), Decimal),
                                    ...
                                    kind: Assignment {
                                        ...
                                        rvalue: Box::new(Expression {
                                            ...
                                            kind: Binary(
                                                ...
                                                Box::new(Expression {
                                                    location: (6, 9).into(),
                                                    kind: Variable(Symbol { name: "b".to_string(), location: (6, 9).into(), original_name: None }),
                                                }),
                                                Box::new(Expression {
                                                    location: (6, 13).into(),
                                                    kind: Variable(Symbol { name: "c".to_string(), location: (6, 13).into(), original_name: None }),
                                                }),
                                            ),
                                        }),
                                        op: None,
    ...
    fn is_equivalent_expression(e1: &Expression, e2: &Expression) -> bool {
        match (&e1.kind, &e2.kind) {
            ...
            (FunctionCall { func_name: f1, actual_params: a1 },
             FunctionCall { func_name: f2, actual_params: a2 }) =>
                f1.name == f2.name &&
                    a1.len() == a2.len() &&
                    a1.iter().zip(a2).all(|(pe1, pe2)| is_equivalent_expression(pe1, pe2)),
            (Increment { is_post: p1, e: e1 }, Increment { is_post: p2, e: e2 }) => p1 == p2 && is_equivalent_expression(&*e1, &*e2),
            (Decrement { is_post: p1, e: e1 }, Decrement { is_post: p2, e: e2 }) => p1 == p2 && is_equivalent_expression(&*e1, &*e2),
            _ => false,
        }
    }
